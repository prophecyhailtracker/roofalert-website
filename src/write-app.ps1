# Define the file path to App.js
$path = "$env:USERPROFILE\roofalert-website\src\App.js"
    ...
    <div style={{ padding: "2rem", fontFamily: "sans-serif", background: "#fff", color: "#000" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "2rem", justifyContent: "center" }}>
        <div style={cardStyle}>
          ...
          <p>Choose your cities, ZIP codes, and strike zones — we send verified addresses only.</p>
        </div>
        <div style={cardStyle}>
...
Write-Host "✅ App.js successfully updated at $path"
